...
?>
<div class="tmw-slot-machine tmw-slot-machine--lux" data-win-rate="<?php echo esc_attr($win_rate); ?>" data-sound-default="<?php echo esc_attr($sound_default); ?>" data-offers="<?php echo $offers_json; ?>" style="position:relative!important;height:130px!important;padding:0!important;border-radius:8px!important;background:linear-gradient(135deg,#1a1a1a 0%,#0d0d0d 50%,#1a1a1a 100%)!important;overflow:hidden!important;box-shadow:0 0 0 1px rgba(212,175,55,0.4),0 0 0 3px rgba(212,175,55,0.15),0 20px 40px -15px rgba(0,0,0,0.6),inset 0 1px 0 rgba(255,255,255,0.05)!important;font-family:Montserrat,sans-serif!important;border:2px solid rgba(212,175,55,0.5)!important;min-height:auto!important;max-height:130px!important;">

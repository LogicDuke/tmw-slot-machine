...
/* Animations - must be in stylesheet, not inline */
...
.tmw-slot-machine.tmw-slot-machine--lux .slot-result.win-text { color: #f4e4bc !important; animation: tmw-text-flash 1s ease-in-out infinite !important; }
.tmw-slot-machine.tmw-slot-machine--lux .slot-result.lose-text { color: rgba(255,255,255,0.6) !important; animation: tmw-text-flash 1s ease-in-out infinite !important; }
...
@media (max-width: 650px) {
  .tmw-slot-machine.tmw-slot-machine--lux { height: auto !important; min-height: 300px !important; padding: 40px 20px 20px !important; }
  ...
  .tmw-slot-machine.tmw-slot-machine--lux .slot-right { order: 3 !important; width: 100% !important; }
...
@media (max-width: 480px) {
  ...
  .tmw-slot-machine.tmw-slot-machine--lux .slot-right .tmw-claim-bonus { width: 180px !important; min-width: 180px !important; }
  .tmw-slot-machine.tmw-slot-machine--lux .reel { width: 52px !important; height: 52px !important; }
}
</style>

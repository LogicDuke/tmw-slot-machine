...
?>
<div class="tmw-slot-machine tmw-slot-machine--lux" data-win-rate="<?php echo esc_attr($win_rate); ?>" data-sound-default="<?php echo esc_attr($sound_default); ?>" data-offers="<?php echo $offers_json; ?>"<?php echo $tmw_slot_machine_audit_attrs; ?> style="position:relative!important;height:130px!important;padding:0!important;border-radius:8px!important;background:linear-gradient(135deg,#1a1a1a 0%,#0d0d0d 50%,#1a1a1a 100%)!important;overflow:hidden!important;box-shadow:0 0 0 1px rgba(212,175,55,0.4),0 0 0 3px rgba(212,175,55,0.15),0 20px 40px -15px rgba(0,0,0,0.6),inset 0 1px 0 rgba(255,255,255,0.05)!important;font-family:Montserrat,sans-serif!important;border:2px solid rgba(212,175,55,0.5)!important;min-height:auto!important;max-height:130px!important;">
  ...
  <div class="slot-body" style="display:flex!important;align-items:center!important;justify-content:space-between!important;height:100%!important;padding:0 28px!important;position:relative!important;z-index:5!important;min-height:auto!important;">
    ...
    <div class="slot-right" style="display:flex!important;flex-direction:column!important;align-items:center!important;justify-content:center!important;gap:6px!important;flex-shrink:0!important;min-width:150px!important;min-height:auto!important;">
...
.tmw-slot-machine.tmw-slot-machine--lux .slot-result.win-text,.tmw-slot-machine.tmw-slot-machine--lux .tmw-result.win-text{color:#f4e4bc!important;animation:tmw-text-flash 1s ease-in-out infinite!important}
.tmw-slot-machine.tmw-slot-machine--lux .slot-result.lose-text,.tmw-slot-machine.tmw-slot-machine--lux .tmw-result.lose-text{color:rgba(255,255,255,0.6)!important;animation:tmw-text-flash 1s ease-in-out infinite!important}
...
.tmw-slot-machine.tmw-slot-machine--lux .tmw-surprise-img{max-width:45px!important;max-height:45px!important;filter:drop-shadow(0 2px 8px rgba(212,175,55,0.3))!important}
...
.tmw-slot-machine.tmw-slot-machine--lux{height:auto!important;min-height:280px!important;max-height:none!important;padding:40px 20px 20px!important}
.tmw-slot-machine.tmw-slot-machine--lux .slot-body{flex-direction:column!important;align-items:center!important;gap:12px!important;padding:0!important}
.tmw-slot-machine.tmw-slot-machine--lux .slot-center{position:relative!important;left:auto!important;top:auto!important;transform:none!important;order:1!important}
.tmw-slot-machine.tmw-slot-machine--lux .slot-left{order:2!important;width:100%!important}
.tmw-slot-machine.tmw-slot-machine--lux .slot-left .slot-btn{width:220px!important;min-width:220px!important}
.tmw-slot-machine.tmw-slot-machine--lux .slot-left .slot-sound{display:none!important}
.tmw-slot-machine.tmw-slot-machine--lux .slot-right{order:3!important;width:100%!important;min-height:auto!important}
.tmw-slot-machine.tmw-slot-machine--lux .slot-right .tmw-claim-bonus{width:220px!important;min-width:220px!important}
.tmw-slot-machine.tmw-slot-machine--lux .slot-right .slot-result{font-size:15px!important;max-width:100%!important}
.tmw-slot-machine.tmw-slot-machine--lux .mobile-sound{display:flex!important;justify-content:center!important;width:100%!important;margin-top:8px!important;order:10!important}
.tmw-slot-machine.tmw-slot-machine--lux .slot-headline{font-size:12px!important;top:14px!important}
.tmw-slot-machine.tmw-slot-machine--lux .teaser-text{font-size:16px!important}
.tmw-slot-machine.tmw-slot-machine--lux .reel{width:58px!important;height:58px!important}
}
</style>
